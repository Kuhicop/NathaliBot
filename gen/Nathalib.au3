...
;Func _TakeSS(ByRef $SSpath, ByRef $SSX1, ByRef $SSY1)
;	;DllCall($CaptureDLL, "int", "CaptureRegion", "str", $SSpath, "int", $SSX1, "int", $SSY1, "int", 50, "int", 50, "int", -1)
;	If _ScreenCapture_Capture("example.jpg",$SSX1,$SSY1,50,50,False) Then
;		Return True
;	Else
;		Return False
;	EndIf
